...
Everything in *Iwao: The Particle Heir* was played, not written. A language model held the Dungeon Master's chair and narrated; a deterministic TypeScript engine — the Hidden Hand MCP server — owned every number. The DM never rolled a die in its head, never decided a save succeeded because the plot wanted it to, never granted a level because the scene felt earned. It *asked the engine,* and the engine answered with the same indifference it shows everyone. Volume One is what came out the other side. This debrief is the audit trail.
...
- **Day 23 — the deferred awakening.** The plan, the pacing, the dignitaries all pointed at the heir awakening the Particle Release before Vohl, the Third Stoneward. The d20 came up a natural 1. The bloodline *refused him.* Rather than retcon the roll, the awakening was deferred twenty-three in-story days and the failure became the spine of the arc — Vohl turning a fumble into the real lesson (*hold the natures like a frame, not a fist*). A scripted story never fumbles its own climax. This one did, and was better for it.
...
FINDINGS (5): bloodline-param bug_1780212505469/4253221 (high, +test) · agent_context-jutsu bug_1780214524649/af5d2be (high, +test) · turnBudget-persist bug_1780248689058/560e96e (medium, found LIVE, +test) · standing-inflation bug_1780245857774 (low, design-resolved: renown vs Stone-Oath) · rank-by-level bug_1780247960181 (low, closed in-fiction by withheld promotion).
...
LOOP: play → detect → file (Agent Synch hidden-hand-playtest) → patch (packages/engine/src) → regress → resume. The campaign was the QA harness; the manga is its artifact.
